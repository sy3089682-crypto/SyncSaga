# Graph Report - sagesync  (2026-06-03)

## Corpus Check
- 193 files · ~60,578 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1256 nodes · 1799 edges · 87 communities (66 shown, 21 thin omitted)
...
Cohesion: 0.05
Nodes (37): TwoFactorSetupPage(), inter, metadata, viewport, GlobalShortcuts(), InnerProviders(), Providers(), SocketInitializer() (+29 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (48): dependencies, compression, cookie-parser, cors, csrf, dotenv, express, helmet (+40 more)

### Community 2 - "Community 2"
Cohesion: 0.08
Nodes (20): useRetention(), Toast, ToastContextValue, ToastProvider(), ToastType, useToast(), Analytics, EventProperties (+12 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (43): dependencies, clsx, framer-motion, livekit-client, @livekit/components-react, lucide-react, next, react (+35 more)
...
Cohesion: 0.06
Nodes (30): description, devDependencies, husky, lint-staged, prettier, turbo, vitest, engines (+22 more)
...
Cohesion: 0.18
Nodes (13): chatHandler(), presenceHandler(), roomHandler(), heartbeatIntervals, logicalClocks, recentEvents, rttMap, syncHandler() (+5 more)

### Community 12 - "Community 12"
Cohesion: 0.14
Nodes (20): CloudflareConfig, CloudflareProvider, createCloudflareProvider(), EmbeddingResponse, TextGenerationResponse, createGeminiProvider(), GeminiConfig, GeminiProvider (+12 more)

### Community 13 - "Community 13"
Cohesion: 0.13
Nodes (17): checkMessage(), detectPersonalInfo(), detectSpam(), ModerationResult, PROFANITY_WORDS, profanityPattern, sanitizeContent(), ProviderHealth (+9 more)

### Community 14 - "Community 14"
Cohesion: 0.11
Nodes (14): AppError, ErrorCodes, errorHandler(), rateLimitMiddleware(), createRoomSchema, requireAuth(), router, CreateNotification (+6 more)

### Community 15 - "Community 15"
Cohesion: 0.12
Nodes (17): supabase, verifyToken(), env, getUser(), router, requireAuth(), requireAuth(), getUser() (+9 more)
...
Cohesion: 0.17
Nodes (17): env, generateAccessToken(), generateRefreshToken(), JwtPayload, RefreshJwtPayload, revokeAllRefreshTokens(), revokeRefreshToken(), rotateRefreshToken() (+9 more)

### Community 20 - "Community 20"
Cohesion: 0.16
Nodes (14): ClipsPage(), CreateRoomPage(), FriendsPage(), cn(), debounce(), formatTime(), AnimeCard, formats (+6 more)
...
Cohesion: 0.11
Nodes (18): dependsOn, outputs, cache, cache, persistent, globalDependencies, dependsOn, pipeline (+10 more)
...
Cohesion: 0.14
Nodes (12): REACTION_TYPES, ReactionBar(), TimelineReaction, TimelineReactions(), useSocket(), SyncState, useSyncEngine(), EmbedRoomPage() (+4 more)

### Community 28 - "Community 28"
Cohesion: 0.22
Nodes (12): AiRecap(), AiRecapProps, RecapData, ClipCapture(), formatTime(), FriendsFeed(), Recommendation, TasteGraph() (+4 more)
...
Cohesion: 0.18
Nodes (9): csrfProtection(), RATE_LIMIT_TIERS, SAFE_METHODS, securityMiddleware(), Env, envSchema, getEnv(), isDevelopment() (+1 more)

### Community 39 - "Community 39"
Cohesion: 0.14
Nodes (12): Activity, activityColors, activityIcons, activityLabels, AppState, AuthSlice, initialAuth, initialRoom (+4 more)
...
Cohesion: 0.24
Nodes (6): anilist, AnimeInfoSidebar(), AnimeInfoSidebarProps, EpisodePicker(), EpisodePickerProps, jikan
...
Cohesion: 0.33
Nodes (5): CinemaMode, CinemaOverlay(), modes, VirtualCinema(), VirtualCinemaProps
...
## Knowledge Gaps
- **624 isolated node(s):** `name`, `version`, `private`, `description`, `workspaces` (+619 more)
...
- **Why does `cn()` connect `Community 20` to `Community 0`, `Community 39`, `Community 59`, `Community 47`, `Community 49`, `Community 27`, `Community 28`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `logger` connect `Community 10` to `Community 38`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 19`, `Community 63`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `useAppStore` connect `Community 28` to `Community 0`, `Community 2`, `Community 37`, `Community 39`, `Community 47`, `Community 20`, `Community 27`?**
