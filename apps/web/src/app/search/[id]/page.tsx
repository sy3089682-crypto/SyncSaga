        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1 min-w-0 space-y-8">
            ...
            <div className="flex items-center gap-3">
              <Link
                href={`/room/create?animeId=${media.id}&title=${encodeURIComponent(title)}`}
              ...
              <section>
                ...
                <div className="space-y-1">
                  {episodes.slice(0, episodePage * 25).map((ep: any) => (
                    <Link
                      key={ep.mal_id}
                      href={`/room/create?animeId=${media.id}&episode=${ep.mal_id}&title=${encodeURIComponent(title)}`}
              ...
              <div className="space-y-2">
                {media.studios?.nodes?.length > 0 && (
                  <div className="flex justify-between text-xs">
                    ...
                    <span>
                      {media.studios.nodes.filter(
                        (s: any) => s.isAnimationStudio,
                      )[0]?.name || media.studios.nodes[0]?.name}
                    </span>
                  </div>
                )}
