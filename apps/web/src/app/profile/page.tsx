    ...
    <div className="min-h-screen bg-canvas text-ink pb-20 lg:pb-0">
      <div className="max-w-4xl mx-auto px-4 py-8">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          {/* Banner */}
          <div className="h-48 rounded-2xl bg-gradient-to-r from-amber/30 via-amber-hover/20 to-amber/30 border border-border overflow-hidden relative mb-20">
          ...
          <div className="flex items-end gap-6 -mt-28 px-6 relative z-10">
            <div className="w-28 h-28 rounded-2xl bg-gradient-to-br from-amber to-amber-hover flex items-center justify-center text-4xl font-bold border-4 border-canvas shadow-xl">
            ...
            <button className="ml-auto mb-2 px-5 py-2.5 rounded-xl bg-amber text-canvas font-medium hover:bg-amber-hover transition-colors">
              Edit Profile
            </button>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4 mt-8">
            {[
              ...
              >
                <Icon className="w-5 h-5 mx-auto mb-2 text-ink-mute" />
          ...
          <div className="mt-8 p-5 rounded-2xl bg-surface border border-border">
            ...
            <p className="text-ink-soft">{user?.bio || 'No bio yet'}</p>
          </div>
          ...
          <div className="mt-6 p-5 rounded-2xl bg-surface border border-border">
            ...
            <div className="flex gap-3">
              <div className="px-4 py-2 rounded-xl bg-elevated border border-border text-sm text-ink-soft">No badges yet</div>
            </div>
          </div>
        </motion.div>
      </div>
